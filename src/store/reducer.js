...
const gamePanelClose = (state, action) => {
  ...
  return updateObject(state, { activePanel: panel });
};
...
const sendResetPasswordMailStart = (state, action) => {
  return updateObject(state, {
    error: null,
    loadingAuth: false,
    actionSuccess: false,
...
const sendResetPasswordMailSuccess = (state, action) => {
  return updateObject(state, {
    error: false,
    loadingAuth: false,
		actionSuccess: true,
...
const sendResetPasswordMailFail = (state, action) => {
  return updateObject(state, {
    error: action.error,
    loadingAuth: false,
		actionSuccess: false,
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.SEND_PASSWORD_RESET_EMAIL_START:
      return sendResetPasswordMailStart(state, action);
    case actionTypes.SEND_PASSWORD_RESET_EMAIL_SUCCESS:
      return sendResetPasswordMailSuccess(state, action);
    case actionTypes.SEND_PASSWORD_RESET_EMAIL_FAIL:
      return sendResetPasswordMailFail(state, action);
    ...
    case actionTypes.MESSAGE_SHOW:
      return messageShow(state, action);
    case actionTypes.MESSAGE_CLOSE:
      return messageClose(state, action);
    default:
      return state;
  }
};
